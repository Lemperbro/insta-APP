    ...
    <div class="w-full sm:max-w-md relative h-screen sm:h-auto">
        ...
        <div
            ...
            <div class="px-8 pt-16 pb-8">
                <h2 class="text-2xl font-bold text-center text-gray-800 dark:text-gray-100 mb-1">Login InstaApp</h2>
                ...
                <form class="space-y-6" wire:submit="login">
                    ...
                    <!-- Login Button -->
                    <div class="pt-2 grid grid-cols-1 gap-4">
                        <x-buttons.button type="submit" iconClass="ti ti-login-2 text-lg" color="primary"
                            isGradient="true" class="w-full gap-2" gradientFrom="indigo-600" gradientTo="purple-600"
                            gradientDir="r">
                            Masuk Ke Sistem
                        </x-buttons.button>
                        <x-buttons.button href="{{ route('auth.register') }}" iconClass="ti ti-users-plus text-lg" color="default"
                             class="w-full gap-2" >
                            Daftarkan Akun
                        </x-buttons.button>
                    </div>

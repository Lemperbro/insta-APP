    ...
    <div class="w-full sm:max-w-md relative h-screen sm:h-auto">
        ...
        <div
            ...
            <div class="px-8 pt-16 pb-8">
                <h2 class="text-2xl font-bold text-center text-gray-800 dark:text-gray-100 mb-1">Daftarkan Akun Anda
                </h2>
                <p class="text-gray-500 dark:text-gray-400 text-center text-sm mb-8">Isi form yang telah di sediakan</p>
                ...
                <form class="space-y-6" wire:submit="register">
                    ...
                    <x-ts-password type="password" label="Konfirmasi Password *" icon="key" wire:model="password_confirmation" />
                    <x-ts-input type="number" label="No. Telphone *" icon="phone" wire:model="phone_number" />

                    <div class="pt-2">
                        <x-buttons.button type="submit" iconClass="ti ti-device-floppy text-lg" color="primary"
                            isGradient="true" class="w-full gap-2" gradientFrom="indigo-600" gradientTo="purple-600"
                            gradientDir="r" target="register">
                            Daftarkan
                        </x-buttons.button>
                    </div>
                </form>
            ...
            <div class="text-center py-4 bg-[var(--bg-2)]/80 border-t border-gray-100 dark:border-gray-700/80">
                <p class="text-xs text-gray-500 dark:text-gray-400">
                    © {{ date('Y') }} InstaApp | <span class="text-indigo-500 font-medium">PT. Sevima</span>
                </p>
            </div>
        </div>

<div>
    <aside
        class="hs-overlay overflow-y-auto transform lg:block lg:end-auto lg:bottom-0 fixed top-0 with-vertical h-screen z-[40] flex-shrink-0 border-r-[1px] w-[300px] border-border-1 dark:border-borderDark-1 bg-[var(--sidebar)] left-sidebar sidebar-transition"
            ...
            <div class="px-6 mt-4">
                <nav class="flex flex-col w-full hs-accordion-group sidebar-nav">
                    <ul id="sidebarnav" class="text-sm text-gray-600 dark:text-accentDark-3">
                        ...
                        @include('livewire.partials.panels.sidebar._menu')
                    </ul>
                </nav>
            </div>
        </div>
